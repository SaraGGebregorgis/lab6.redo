...
//diff colors for the charts

function addExpenseToChart(name, amount) {
    //the empty array will be filled bec of this
    //name will be added to the data and the amount will e added to the data
